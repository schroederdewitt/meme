...
import rl_baselines3_zoo_lib.utils.import_envs  # noqa: F401 pytype: disable=import-error
from rl_baselines3_zoo_lib.utils.callbacks import SaveVecNormalizeCallback, TrialEvalCallback
from rl_baselines3_zoo_lib.utils.hyperparams_opt import HYPERPARAMS_SAMPLER
from rl_baselines3_zoo_lib.utils.utils import ALGOS, get_callback_list, get_latest_run_id, get_wrapper_class, linear_schedule
...
class ExperimentManager(object):
    ...
    def read_hyperparameters(self) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        ...
        with open(f"rl_baselines3_zoo_lib/hyperparams/{self.algo}.yml", "r") as f:
